...
switch (_operation) do {
	...
	case "loadData": {
		...
		lbAdd [SCI_QuestionList, "Você já viu alguma IED de ultimamente?"];lbSetData [SCI_QuestionList, 2, "IEDs"];
		...
		lbAdd [SCI_QuestionList, "Você já viu algum comportamento estranho ultimamente?"];lbSetData [SCI_QuestionList, 5, "StrangeBehavior"];
		lbAdd [SCI_QuestionList, "Você nos apoia?"];lbSetData [SCI_QuestionList, 6, "Opinion"];
		lbAdd [SCI_QuestionList, "Qual é a sua opinião sobre as forças de segurança nesta área?"];lbSetData [SCI_QuestionList, 7, "TownOpinion"];
	...
	case "getActivePlan": {
		...
		switch (toLower _activeCommand) do {
			case "alive_fnc_cc_suicide": {
				...
				_activePlan2 = "cinto com explosivos";
				_activePlan3 = "planejando um atentado";
				_activePlan4 = "se preparando para bombardear seus forças";
			...
			case "alive_fnc_cc_rogue": {
				_activePlan1 = "guardar uma arma em sua casa";
				_activePlan2 = "estocando armas";
				_activePlan3 = "pensando em filmar uma patrulha";
				_activePlan4 = "procurando alguém para atirar";
			...
			case "alive_fnc_cc_getweapons": {
				...
				_activePlan2 = "pensando em juntar aos insurgentes";
